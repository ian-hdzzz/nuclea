...
document.addEventListener("DOMContentLoaded", () => {
 ...
 const tutorialSteps = [
  {
    element: "welcome",
    title: "Administrative Offenses Management",
    content: "This guided tour will help you understand how to manage administrative offenses in the system."
  },
  {
    element: "search-section",
    title: "Search Functionality",
    content: "Use this search box to quickly find administrative offenses by employee name."
  },
  {
    element: "add-offense-btn",
    title: "Add New Offense",
    content: "Click this button to add a new administrative offense to the system."
  },
  {
    element: "table-section",
    title: "Offenses Table",
    content: "This table displays all administrative offenses with details about who they're assigned to, the reason, date, and attached files."
  },
  {
    element: "actions-dropdown",
    title: "Manage Actions",
    content: "Click the 'Manage' button to access edit and delete options for each administrative offense."
  },
  {
    element: "modal-content",
    title: "Add Offense Form",
    content: "This form allows you to add a new administrative offense by selecting an employee, date, reason, and optionally attaching a PDF file.",
    showModal: true
  },
  {
    element: "complete",
    title: "Tour Complete!",
    content: "You're now ready to use the Administrative Offenses management system. You can restart the tour anytime using the 'Start Tour' button."
  }
];
...
function endTutorial() {
  ...
  tutorialOverlay.innerHTML = `
    <div class="completion-message">
      ...
      <p>You're now ready to use the Administrative Offenses management system.</p>
