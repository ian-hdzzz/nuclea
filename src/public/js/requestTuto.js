 ...
 const tutorialSteps = [
    {
        ...
        content: "This guided tour will help you understand how to create, view, and manage your absence requests efficiently."
    },
    {
        element: "content",
        title: "Absences and Holidays Overview",
        content: "Here you can see all your submitted absence requests and the list of upcoming holidays to plan your time off better."
    },
    {
        element: "table-container",
        title: "Vacation Requests Table",
        content: "This table displays all your absence requests, including their type, start and end dates, description, and approval statuses."
    },
    {
        element: "holidays-table",
        title: "Holidays Table",
        content: "This section lists official holidays recognized by the company, helping you avoid planning conflicts when requesting time off."
    },
    {
        element: "openModal",
        title: "Add New Request Button",
        content: "Click this button to open the form where you can submit a new request for vacation or other types of absences."
    },
    {
        element: "form-request",
        title: "New Request Form",
        content: "Fill out this form to submit a new absence request by selecting the type, start date, end date, and providing a brief description.",
        showModal: true
    },  
];
...
function endTutorial() {
  ...
  tutorialOverlay.innerHTML = `
    <div class="completion-message">
      ...
      <p>You're now ready to use the Absences Management system and handle your requests.</p>
